...
![img_2.png](/pic/prove_skip_list.png)

查找流程：从头节点开始判断key与当前值和下一个值的大小，决定降低高度查找or本层遍历查找
![img_2.png](/pic/skip_list_find.png)
...
![img_2.png](/pic/skip_list_insert.png)
...
![img_2.png](/pic/internal_key.png)   
Memdb在代码中结构如下：
```go
